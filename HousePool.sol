...
contract HousePool is VRFHelper
{
    ...
    function requestLiquidityRoll(uint256[][3] memory rolls, address token, bytes32 keyHash, uint64 subscriptionId, uint16 requestConfirmations, uint32 callbackGasLimit, uint32 wordCount) internal returns (uint256)
    {
